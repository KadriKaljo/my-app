...
const submit = () => form.put(update(props.post.id).url);
</script>

<template>
  <Head title="Edit Post" />
  <AppLayout :breadcrumbs="[{ title: 'Posts edit', href: edit(props.post.id).url }]">
    <div class="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
      <div class="mx-auto h-full w-full max-w-2xl p-4">
        <h3 class="text-lg font-medium">Post Edit</h3>
